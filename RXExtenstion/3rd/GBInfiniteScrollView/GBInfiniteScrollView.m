...
-(void)panOnScrollView:(UIPanGestureRecognizer*)pan
{
    if (pan.state == UIGestureRecognizerStateBegan) {
        if ([self.infiniteScrollViewDelegate respondsToSelector:@selector(infiniteScrollViewDidBegin:)]) {
            [self.infiniteScrollViewDelegate infiniteScrollViewDidBegin:self];
        }
    }else if(pan.state == UIGestureRecognizerStateEnded)
    {
        if ([self.infiniteScrollViewDelegate respondsToSelector:@selector(infiniteScrollViewEndScroll:)]) {
            [self.infiniteScrollViewDelegate infiniteScrollViewEndScroll:self];
        }
    }
